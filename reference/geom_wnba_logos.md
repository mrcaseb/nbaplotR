...
This geom is used to plot WNBA team logos instead of points in a ggplot.
It requires x, y aesthetics as well as a valid WNBA team abbreviation.
The latter can be checked with
[`valid_team_names()`](https://mrcaseb.github.io/nbaplotR/reference/valid_team_names.md).
...
`geom_wnba_logos()` understands the following aesthetics (required
...
- **team_abbr** - The team abbreviation. Should be one of
  [`valid_team_names()`](https://mrcaseb.github.io/nbaplotR/reference/valid_team_names.md).
  The function tries to clean team names internally by calling
  [`clean_team_abbrs()`](https://mrcaseb.github.io/nbaplotR/reference/clean_team_abbrs.md).
...
team_abbr <- c(team_abbr, rep(NA_character_, 3))
