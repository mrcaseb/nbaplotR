...
This geom is used to plot NBA team logos instead of points in a ggplot.
It requires x, y aesthetics as well as a valid NBA team abbreviation.
...
`geom_nba_logos()` understands the following aesthetics (required
