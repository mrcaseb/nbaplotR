...
These functions map NBA/WNBA team names to their team colors in color
and fill aesthetics
...
The theme elements
[`element_nba_logo()`](https://mrcaseb.github.io/nbaplotR/reference/element.md)
and
[`element_wnba_logo()`](https://mrcaseb.github.io/nbaplotR/reference/element.md)
to replace axis text labels with logos.
